# Arquivo: src/main.py
# Versão com caminhos de arquivo corrigidos
...
# Constrói o caminho para a raiz do projeto de forma robusta e infalível
SRC_DIR = os.path.dirname(os.path.abspath(__file__))
PROJECT_ROOT = os.path.dirname(SRC_DIR)

# Agora, constrói os caminhos a partir da raiz do projeto
...
def run_evaluation_task():
    """Esta função contém a lógica de avaliação que antes estava em evaluate_rag.py"""
